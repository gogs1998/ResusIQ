                ...
                >
                  ...
                  <div className="flex-1">
                    <p
                      ...
                      style={{ color: 'var(--brand-strong)', fontSize: 'var(--fs-caption)', fontWeight: 700, letterSpacing: 'var(--ls-label)' }}
                    >
            ...
            {[...eventHistory].reverse().map((event) => (
              ...
              >
                ...
                <div className="flex gap-2 mt-3">
                  <span
                    className="px-3 py-1"
                    style={{ background: 'var(--brand-tint)', color: 'var(--brand-strong)', borderRadius: 'var(--radius-pill)', fontSize: 'var(--fs-caption)', fontWeight: 600 }}
                  >
